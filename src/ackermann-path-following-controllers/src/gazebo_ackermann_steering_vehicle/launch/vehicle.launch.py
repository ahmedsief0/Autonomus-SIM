...
def start_vehicle_control():
    ...
    @return: A tuple containing spawner Node actions for the joint state, forward velocity, 
...
def generate_launch_description():
    ...
    default_world_path = os.path.join(package_path, 'worlds',
                                      'track_with_cones.sdf')

    # Define a launch argument for the world file, defaulting to track_with_cones.sdf
    world_arg = DeclareLaunchArgument(
        'world', default_value=default_world_path,
        description='Specify the world file for Gazebo (e.g., track_with_cones.sdf or empty.sdf)')
    ...
    z_arg = DeclareLaunchArgument('z', default_value='0.06',
    ...
    ekf_arg = DeclareLaunchArgument(
        ...
        description='Whether to launch the EKF localization node')
    ...
    # Load EKF localization node
    ekf_node = Node(package='gazebo_ackermann_steering_vehicle',
